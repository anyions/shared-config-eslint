...
export type ConfigNames = '@anyions/shared-config-eslint/comments/rules' | '@anyions/shared-config-eslint/prettier/core' | '@anyions/shared-config-eslint/formatter-css/rules' | '@anyions/shared-config-eslint/formatter-scss/rules' | '@anyions/shared-config-eslint/formatter-less/rules' | '@anyions/shared-config-eslint/formatter-html/rules' | '@anyions/shared-config-eslint/formatter-json/rules' | '@anyions/shared-config-eslint/formatter-json5/rules' | '@anyions/shared-config-eslint/formatter-markdown/rules' | '@anyions/shared-config-eslint/ignores/rules' | '@anyions/shared-config-eslint/imports/rules' | '@anyions/shared-config-eslint/javascript/rules' | '@anyions/shared-config-eslint/javascript/disables/cli' | '@anyions/shared-config-eslint/javascript/disables/test' | '@anyions/shared-config-eslint/ignores/rules' | '@anyions/shared-config-eslint/jsonc/core' | '@anyions/shared-config-eslint/jsonc/global/rules' | '@anyions/shared-config-eslint/jsonc/package-json/rules' | '@anyions/shared-config-eslint/jsonc/tsconfig-json/rules' | '@anyions/shared-config-eslint/node/rules' | '@anyions/shared-config-eslint/markdown/core' | '@anyions/shared-config-eslint/markdown/processor' | '@anyions/shared-config-eslint/markdown/rules' | '@anyions/shared-config-eslint/perfectionist/rules' | '@anyions/shared-config-eslint/typescript/core' | '@anyions/shared-config-eslint/typescript/parser' | '@anyions/shared-config-eslint/typescript/rules' | '@anyions/shared-config-eslint/typescript/disables/dts' | '@anyions/shared-config-eslint/typescript/disables/cjs' | '@anyions/shared-config-eslint/unicorn/rules' | '@anyions/shared-config-eslint/unocss/core' | '@anyions/shared-config-eslint/unocss/rules' | '@anyions/shared-config-eslint/vue/core' | '@anyions/shared-config-eslint/vue/rules'
